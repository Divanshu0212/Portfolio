...
const projects = [
  {
    ...
    github: "https://github.com/divanshu0212/bitbybit",
    demo: "",
  ...
  {
    title: "ELIXA",
    subtitle: "GenAI-Powered Agentic Event Orchestration Platform",
    description:
      "Agentic event coordination platform converting plain-language descriptions into 30-60 dependency-linked tasks across 6 phases, using Gemini 2.5 Flash with phase-gated checkpoints and ElevenLabs Turbo v2 voice announcements. Full backend spans 5 SpacetimeDB live-state tables, all Next.js 14 API routes, and a 3-layer persistence system (SpacetimeDB → HTTP relay → MongoDB fallback).",
    tech: ["Next.js 14", "SpacetimeDB (Rust)", "MongoDB Atlas", "Gemini 2.5 Flash", "Claude Sonnet 4", "ElevenLabs Turbo v2"],
    highlights: [
      "🏆 MongoDB Track Winner — HackByte 4.0 (MLH)",
      "Sub-300ms real-time sync across 6 role-scoped operator types",
      "Dependency-locked Go/No-Go launch gate across all 6 phases",
    ],
  ...
  {
    title: "EduHub",
    subtitle: "Multi-Tenant SaaS University ERP Platform",
    description:
      "Multi-tenant SaaS ERP built as 13 independently deployable microservices (Django REST Framework + FastAPI) across 7 fully-implemented domains — auth, finance, hostel, transport, grievance, notification, AI — plus 6 stubbed domains, onboarding unlimited universities on one common schema. Event-driven backbone on a RabbitMQ topic exchange routing 9+ domain event types with a transactional outbox, idempotent inbox, and dead-letter queuing for exactly-once delivery.",
    tech: ["Django REST Framework", "FastAPI", "PostgreSQL 16", "RabbitMQ", "Redis", "Celery", "JWT (HS256)", "Docker"],
    highlights: [
      "13 microservices across 7 fully-implemented domains",
      "Zero-trust JWT re-verified by all 13 services, row-level tenant isolation",
      "143+ backend tests (≥70% coverage gate), 4-stage CI/CD pipeline",
    ],
  ...
  },
  {
    ...
    github: "https://github.com/divanshu0212/b2bsaas",
    demo: "",
